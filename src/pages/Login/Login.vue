            ...
            <section>
              ...
              <section class="login_verification">
                ...
                <div class="switch_button off" :class="showPwd ? 'on':'off'"
                  ...
                  <span class="switch_text">{{showPwd ? 'abc':null}}</span>
                </div>
              </section>
              <section class="login_message">
...
<script>
  ...
  export default {
    data(){
      return{
        loginWay:false,//true为短信登陆，false为密码登陆
        computedTime:0, //倒计时的时间
        showPwd:false,  //是否显示隐藏密码栏
        phone:'',//手机号
        pwd:'', //密码
        name:'',  //用户名
        captcha:'',  //图形验证码
    ...
    methods:{
      ...
      //获取一次性图片验证码。 地址不变时，图片验证码不会变，我们需要用Date.now()
      getCaptcha () {
        //
